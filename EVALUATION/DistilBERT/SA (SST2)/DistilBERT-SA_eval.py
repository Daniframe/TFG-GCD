...
best_model = AutoModelForSequenceClassification.from_pretrained(
    "DistilBERT-SA_lr-5e-05_nep-7/checkpoint-3283")
...
with open(f"DistilBERT-SA_character_level_evaluation.csv", "w") as file:
    file.write(cad)
...
with open(f"DistilBERT-SA_word_level_evaluation.csv", "w") as file:
    file.write(cad)
...
with open(f"DistilBERT-SA_other_evaluation.csv", "w") as file:
    file.write(cad)