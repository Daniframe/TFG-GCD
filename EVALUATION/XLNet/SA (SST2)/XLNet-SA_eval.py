...
best_model = AutoModelForSequenceClassification.from_pretrained(
    "XLNet-SA_lr-1e-05_nep-5/checkpoint-4690")
...
with open(f"XLNet-SA_character_level_evaluation.csv", "w") as file:
    file.write(cad)
...
with open(f"XLNet-SA_word_level_evaluation.csv", "w") as file:
    file.write(cad)
...
with open(f"XLNet-SA_other_evaluation.csv", "w") as file:
    file.write(cad)