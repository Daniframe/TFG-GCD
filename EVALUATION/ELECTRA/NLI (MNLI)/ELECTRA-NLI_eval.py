...
best_model = AutoModelForSequenceClassification.from_pretrained(
    "ELECTRA-NLI_lr-5e-05_nep-5/checkpoint-2345")
...
with open(f"ELECTRA-NLI_character_level_evaluation.csv", "w") as file:
    file.write(cad)
...
with open(f"ELECTRA-NLI_word_level_evaluation.csv", "w") as file:
    file.write(cad)
...
with open(f"ELECTRA-NLI_other_evaluation.csv", "w") as file:
    file.write(cad)