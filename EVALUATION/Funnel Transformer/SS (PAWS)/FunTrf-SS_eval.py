...
best_model = AutoModelForSequenceClassification.from_pretrained(
    "FunTrf-PAWS_lr-5e-05_nep-10/checkpoint-4690")
...
with open(f"FunTrf-SS_character_level_evaluation.csv", "w") as file:
    file.write(cad)
...
with open(f"FunTrf-SS_word_level_evaluation.csv", "w") as file:
    file.write(cad)
...
with open(f"FunTrf-SS_other_evaluation.csv", "w") as file:
    file.write(cad)