...
best_model = AutoModelForSequenceClassification.from_pretrained(
    "ELECTRA-PAWS_lr-5e-05_nep-7/checkpoint-3283")
...
with open(f"ELECTRA-SS_character_level_evaluation.csv", "w") as file:
    file.write(cad)
...
with open(f"ELECTRA-SS_word_level_evaluation.csv", "w") as file:
    file.write(cad)
...
with open(f"ELECTRA-SS_other_evaluation.csv", "w") as file:
    file.write(cad)