...
best_model = AutoModelForSequenceClassification.from_pretrained(
    "FunTrf-NLI_lr-1e-05_nep-7/checkpoint-3283")
...
with open(f"FunTrf-NLI_character_level_evaluation.csv", "w") as file:
    file.write(cad)
...
with open(f"FunTrf-NLI_word_level_evaluation.csv", "w") as file:
    file.write(cad)
...
with open(f"FunTrf-NLI_other_evaluation.csv", "w") as file:
    file.write(cad)