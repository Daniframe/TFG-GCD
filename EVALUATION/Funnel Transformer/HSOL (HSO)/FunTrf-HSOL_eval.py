...
best_model = AutoModelForSequenceClassification.from_pretrained(
    "FunTrf-HSOL_lr-1e-05_nep-5/checkpoint-4340")
...
out = [1199, 1648, 1901, 1903, 2097, 2355, 2567, 4092]
...
for perturbation in Trf2.ALLOWED_CHARACTER_LEVEL_PERTURBATIONS:
    for perturbation_proportion in [0.01, 0.05, 0.1]:
        ...
        print(perturbation.lower(), perturbation_proportion)
...
with open(f"FunTrf-HSOL_character_level_evaluation.csv", "w") as file:
    file.write(cad)
...
with open(f"FunTrf-HSOL_word_level_evaluation.csv", "w") as file:
    file.write(cad)
...
with open(f"FunTrf-HSOL_other_evaluation.csv", "w") as file:
    file.write(cad)