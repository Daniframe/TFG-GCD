...
best_model = AutoModelForSequenceClassification.from_pretrained(
    "DistilBERT-HSOL_lr-5e-05_nep-7/checkpoint-3038")
...
with open(f"DistilBERT-HSOL_character_level_evaluation.csv", "w") as file:
    file.write(cad)
...
with open(f"DistilBERT-HSOL_word_level_evaluation.csv", "w") as file:
    file.write(cad)
...
with open(f"DistilBERT-HSOL_other_evaluation.csv", "w") as file:
    file.write(cad)