...
best_model = AutoModelForSequenceClassification.from_pretrained(
    "XLNet-PAWS_lr-5e-05_nep-5/checkpoint-4690")
...
with open(f"XLNet-SS_character_level_evaluation.csv", "w") as file:
    file.write(cad)
...
with open(f"XLNet-SS_word_level_evaluation.csv", "w") as file:
    file.write(cad)
...
with open(f"XLNet-SS_other_evaluation.csv", "w") as file:
    file.write(cad)